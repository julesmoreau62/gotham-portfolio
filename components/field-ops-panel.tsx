...
export function FieldOpsPanel({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  const skipIntro = () => { hasPlayedIntro.current = true; setPhase("main"); setTimeout(() => setVisible(true), 50) }
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-background flex flex-col overflow-hidden">
      ...
      {/* Scrollable content */}
      <main ref={scrollRef} className="flex-1 overflow-y-auto p-4 md:p-6 z-10">
