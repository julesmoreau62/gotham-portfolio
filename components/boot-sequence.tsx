...
const BOOT_LINES = [
  ...
  { text: "[OK] Recruiter briefing route: /briefing", delay: 500, type: "ok" },
  ...
  { text: ">>  FOCUS: ESPORTS OPERATIONS", delay: 1100, type: "clearance" },
  { text: ">>  STATUS: PORTFOLIO LIVE", delay: 1250, type: "status" },
